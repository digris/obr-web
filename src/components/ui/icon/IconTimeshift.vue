...
<template>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" x="10" y="0" viewBox="0 0 48 48" :style="style">
    <path d="M22.5,13.6v8.9v3v0h8v-3h-5v-8.9c-0.5-0.1-1-0.1-1.5-0.1S23,13.5,22.5,13.6z" />
    <path
    ...
    />
    <polygon points="22.5,41 22.5,31 27.5,36 " />
  </svg>
